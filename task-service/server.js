...
http.createServer(async (req, res) => {
  ...
  if (
    ...
    try {
      ...
      if (!cleanTitle || cleanTitle.length > 140) {
        return json(res, 400, {
          message: 'Task title must be between 1 and 140 characters.'
        });
      }
      ...
      if (
        ...
        return json(res, 400, {
          message: 'Choose a valid deadline date.'
        });
      }
  ...
  console.log(
    `Task service listening on http://localhost:${port}`
  );
});